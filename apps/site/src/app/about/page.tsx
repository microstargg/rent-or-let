        ...
        <div className="grid gap-12 lg:grid-cols-5">
          ...
          <div className="lg:col-span-2">
            <div
              className={
                isVeri
                  ? "border-b border-foreground/15 pb-6"
            ...
            >
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                <Button asChild size="sm" className={isVeri ? "rounded-full" : undefined}>
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {pillars.map(({ icon: Icon, title, text }) => (
            <div
              ...
              className={
                isVeri
                  ? "border-b border-foreground/10 pb-6 text-left"
            ...
            >
              <Icon
                className={
                  isVeri
                    ? "mb-4 h-7 w-7 text-[oklch(0.55_0.08_55)]"
                    : "mx-auto mb-4 h-8 w-8 text-primary"
                }
              />
